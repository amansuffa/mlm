...
${disclaimer}
    ...
    },
    {
      ...
      category: "Admin",
      subject: "Admin Fee Payment Received – {{MemberName}}",
      body: `
    Hello Admin,<br><br>
The following member has successfully paid the one-time $50 admin fee.<br><br>
<strong>Details:</strong><br>
...
`,
    ...
    },
    {
      ...
      category: "Admin",
      subject: "Membership Payment Sent – {{MemberName}}",
      body: `
     Hello Admin,<br><br>
...
${disclaimer}
  ...
  `,
    ...
    },
    {
      ...
      Stay tuned – you’ll get notified as soon as they complete the next step.<br><br>
    ...
    },
    {
      ...
      ⚠️ <strong>Note:</strong> Their membership will remain pending until you approve the payment. Once confirmed, their account will be activated immediately.<br><br>
      Confirm now so your new team member can start building and earning!<br><br>
      👉 Stay focused. The momentum is real.<br><br>
      Let’s make your next $500 yours! 💸<br><br>
