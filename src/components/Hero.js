...
export default function HomePage() {
  ...
  const stats = [
    ...
    {
      icon: DollarSign,
      value: "Trusted Curriculum",
      label: "Structured Tracks",
      delay: 0.2,
    },
  ...
  const features = [
    {
      ...
      description:
        "Implementation-ready funnels and systems to help translate training into practical results.",
    },
    {
      icon: TrendingUp,
      title: "Step-by-Step Training",
      description:
        "Clear, beginner-friendly training that guides skill development and practical application.",
    },
    {
      icon: Award,
      title: "Peer-to-peer Partner Contribution Structure",
      description:
        "An optional Partner Program that supports peer contributions between members; participation is optional and managed directly by members.",
    },
    {
      icon: Bot,
      title: "AI Learning Assistant",
      description:
        "An AI assistant to help explain lessons, provide implementation guidance, and support learner questions.",
    },
    {
      icon: Users,
      title: "Mentorship & Peer Support",
      description:
        "Access guidance from experienced professionals and peers focused on skill development and best practices.",
    },
    {
      icon: Globe,
      title: "Global Learning Network",
      description:
        "Collaborate with learners around the world and access resources from anywhere.",
    },
  ];
  ...
  const faqItems = [
    {
      ...
      answer:
        "PASH.CLUB is a professional training platform focused on digital skills development, practical implementation tools, and ongoing mentorship.",
    },
    {
      question: "Do I need experience?",
      answer:
        "No. The platform provides beginner-friendly, step-by-step training and implementation guidance.",
    },
    {
      question: "Is this an income guarantee program?",
      answer:
        "No. This is a professional training platform focused on skill development. There is no income guarantee; outcomes depend on individual effort and application. Participation in the Partner Program is optional and does not guarantee income.",
    },
    {
      question: "Is this a global system?",
      answer:
        "Yes. Learners from around the world can join and access training resources.",
    },
  ];
    ...
    <>
      ...
      <section className="min-h-screen flex items-center relative overflow-hidden">
                ...
                <div className="flex flex-col items-center justify-center text-center">
                  <motion.div
                    ...
                    style={{
                      ...
                      color: "var(--text)",
                      border:
                        "1px solid rgba(var(--primary-rgb, 59, 130, 246), 0.2)",
                    }}
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">
                      Your Invitation to an Elevated Lifestyle
                    </span>
                  </motion.div>

                  <h1
                    className="text-4xl md:text-5xl lg:text-6xl font-bold lg:px-16 mb-6"
                  ...
                  <p
                    ...
                    style={{ color: "var(--text)" }}
                  >
                    Structured training, clear pathways, and guided support for
                    practical skill development.
                  </p>

                  <p
                    className="text-lg opacity-90 mb-8 lg:px-16"
                    style={{ color: "var(--text)" }}
                  >
                    Join PASH.CLUB to access professional training,
                    implementation tools, and mentorship — Partner Program
                    participation is optional and not required to access
                    training.
                  </p>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          ...
          >
            <ChevronRight
              className="w-6 h-6 opacity-50 transform rotate-90"
              style={{ color: "var(--text)" }}
            />
          </motion.div>
        </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="flex flex-col justify-center items-center">
                  ...
                  <p
                    ...
                    style={{ color: "var(--text)" }}
                  >
                    Review the program overview, Partner Program details
                    (optional), and how membership access and any peer
                    contributions are managed. This PDF explains access,
                    expectations, and policies in clear terms.
                  </p>
                  <motion.a
                    href={compImage}
          ...
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                ...
                style={{ color: "var(--text)" }}
              >
                PASH.CLUB gives you training, implementation tools, and
                mentorship to build practical digital skills from anywhere. No
                experience required — just a willingness to learn and apply.
              </p>
            </div>
          </AnimatedSection>
            ...
            <AnimatedCard delay={0.2}>
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "var(--text)" }}
                >
                  PASH.CLUB is designed to help everyday people build practical
                  digital skills and apply them with confidence — even if
          ...
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                ...
                style={{ color: "var(--text)" }}
              >
                Six powerful components that work together to create your
                success system
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p
                ...
                style={{ color: "var(--text)" }}
              >
                The platform is evolving. Early-stage access offers a chance to
                shape the experience and receive guided support.
              </p>
              ...
              >
                <p
                  ...
                  style={{ color: "var(--text)" }}
                >
                  Early participants help shape the platform and gain closer
                ...
                <p
                  ...
                  style={{ color: "var(--text)" }}
                >
                  The platform is designed for steady progress — focused
                  learning and consistent application lead to the best outcomes.
                </p>
                <p
                  className="text-2xl font-bold"
                  style={{ color: "var(--primary)" }}
                >
                  Consider early access if you want structured support and a
      ...
      <section className="py-20" style={{ backgroundColor: "var(--card)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p
                ...
                style={{ color: "var(--text)" }}
              >
                Join thousands of learners who have strengthened their digital
                skills and applied them to real projects
              </p>
            </div>
          </AnimatedSection>
            ...
            {testimonials.map((testimonial, index) => (
              <AnimatedCard key={index} delay={index * 0.1}>
                ...
                >
                  ...
                  <p
                    className="italic mb-4 text-sm opacity-90 flex-grow"
                    style={{ color: "var(--text)" }}
                  >
          ...
          <div className="text-center mt-16">
            <AnimatedSection>
              <p className="opacity-80 mb-4" style={{ color: "var(--text)" }}>
                Read verified reviews from our members
              </p>
              <a
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                <div>
                  ...
                  <p
                    ...
                    style={{ color: "var(--text)" }}
                  >
                    PASH.CLUB is founded by Pasha Rana, an experienced
                    entrepreneur and educator who has worked in online business
                    and training since 2013.
                  </p>
                  <p
                    className="opacity-80 mb-6"
                    style={{ color: "var(--text)" }}
                  >
                    Registered as PASH CLUB LLC in New Mexico, USA, with
                    additional operations in Toronto, Canada — the platform is
                    built on trust, professionalism, and long-term stability.
                  </p>
                  ...
                  <div className="mb-6">
                    <h4
                      ...
                      style={{ color: "var(--text)" }}
                    >
                      After helping thousands of people, Pasha realized most
                      beginners fail because they {"don't"} have:
                    </h4>
                  ...
                  <p
                    ...
                    style={{ color: "var(--primary)" }}
                  >
                    So he built PASH.CLUB, a modern solution designed to
                    eliminate confusion and give anyone the tools to apply
                    skills and grow professionally.
                  </p>

                  <Link
                    href={getUrlWithRef("/about")}
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-opacity hover:opacity-80 mt-8"
                    style={{
                      backgroundColor: "var(--primary)",
                      color: "white",
                    }}
      ...
      <section className="py-20" style={{ backgroundColor: "var(--card)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              href={getUrlWithRef("/faq")}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-opacity hover:opacity-80"
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p
              ...
              style={{ color: "var(--text)" }}
            >
              {"You're"} one decision away from accessing structured training,
              practical tools, and a supportive community for professional
              growth.
              <br />
          ...
          <AnimatedSection delay={0.5}>
            ...
            >
              <p
                className="text-2xl font-bold mb-4 opacity-90"
                style={{ color: "var(--text)" }}
              >
                Success loves speed.
              </p>
              ...
              <p
                className="text-lg opacity-80 mt-4"
                style={{ color: "var(--text)" }}
              >
