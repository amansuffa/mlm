  ...
  return (
    <div className="rounded-2xl shadow-lg p-6" style={{ backgroundColor: 'var(--card)', border:`1px solid var(--border)`}}>
      ...
      <p className="text-sm mb-4" style={{ color: 'var(--text)', opacity: 0.8 }}>
        ...
        upload proof of payment. Approval may take 24–48 hours.<br/>
Make sure to upload your payment proof before closing the window; otherwise, the payment will not be accepted.      </p>
